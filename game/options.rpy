...
define config.save_directory = "gambling-1755352444"
...
init python:
    ...
    # Preserve any existing input handlers.
    # config.overlay_screens.append("global_click_catcher")


    _preferences.set_volume('music', 0.25)
    _preferences.set_volume('sound', 0.25)
